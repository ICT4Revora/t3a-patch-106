...
[Setup]
AppName=T3A Patch for BFME 1 POLISH
AppVersion=1.06
AppId=T3APATCH106
...
OutputBaseFilename=T3AOnlineBFME1_Patch1.06_POLISH
...
Source: "_patch106polish.big"; DestDir: "{app}"
Source: "_polishpatch106.big"; DestDir: "{app}"
